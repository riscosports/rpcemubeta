...
extern int hostfs_supports_xattr_platform();
extern int hostfs_read_object_xattr_platform(const char *host_pathname, risc_os_object_info *object_info);
extern void hostfs_object_set_xattr_platform(const char *host_path,
											 uint32_t load,
											 uint32_t exec,
											 uint32_t attribs);
